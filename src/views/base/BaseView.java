...
public abstract class BaseView extends JFrame implements IView {
	...
	private void setProperty() {
		if (isMaximize) {
			System.setProperty(getEnv(Environment.MAIN_WIDTH), Integer.toString(getWidth()));
			System.setProperty(getEnv(Environment.MAIN_HEIGHT), Integer.toString(getHeight()));
		}
	}
